...
// Get post via :postID
router.get('/post/:postId', (req: Request, res: Response, next: NextFunction) => {
...
router.put('/post/:postId', async (req: Request, res: Response, next: NextFunction) => {
  const postId = req.params.postId;
...
router.delete('/post/:postId', async (req: Request, res: Response, next: NextFunction) => {
  const postId = req.params.postId;
  const postRepo = getConnection().getRepository(Post);
